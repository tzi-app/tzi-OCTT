...
async def test_tc_n_63():
    ...
    await send_call(cp_id, "CustomerInformation", {
        ...
        "customerCertificate": {
            ...
            "issuerNameHash": "aabbccddaabbccddaabbccddaabbccddaabbccddaabbccddaabbccddaabbccdd",
            "issuerKeyHash": "eeff0011eeff0011eeff0011eeff0011eeff0011eeff0011eeff0011eeff0011",
